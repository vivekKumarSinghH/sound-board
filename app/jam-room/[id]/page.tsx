...
export default function JamRoomPage() {
  ...
  const playLoop = async (loopId: string) => {
    ...
    try {
      ...
      // Set volume
      audioElementsRef.current[loopId].volume = mutedLoops[loopId]
        ? 0
        : loopVolumes[loopId] / 100;
  ...
  const toggleMute = (loopId: string) => {
    ...
    if (audioElementsRef.current[loopId]) {
      audioElementsRef.current[loopId].volume = newMuted
        ? 0
        : loopVolumes[loopId] / 100;
    }
  };
  ...
  const copyRoomCode = () => {
    ...
    toast({
      ...
      description:
        "Share this code with others to invite them to your jam session.",
    });
  };
        ...
        <div className="container flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <div className="text-sm">
              <span className="text-muted-foreground mr-2">BPM:</span>
              <span className="font-medium">{room.bpm}</span>
              <span className="text-muted-foreground mx-2">•</span>
              <span className="text-muted-foreground mr-2">Key:</span>
              <span className="font-medium">{room.keySignature}</span>
            </div>
            <Button
              variant="outline"
              size="sm"
      ...
      <main className="flex-1 container py-8">
        <div className="flex justify-center mb-6">
          <div className="inline-flex rounded-md shadow-sm">
            <Button
              variant={activeTab === "loops" ? "default" : "outline"}
              className={
                activeTab === "loops" ? "bg-purple-600 hover:bg-purple-700" : ""
              }
            ...
            <Button
              ...
              className={`ml-px ${
                activeTab === "mixer" ? "bg-purple-600 hover:bg-purple-700" : ""
              }`}
                        ...
                        <div className="mt-4">
                          <div className="flex items-center gap-4">
                            ...
                            <Slider
                              ...
                              className="flex-1"
                              onValueChange={(value) =>
                                handleVolumeChange(loop.id, value)
                              }
                            />
